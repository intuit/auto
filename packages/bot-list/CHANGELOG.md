...
- add mergify[bot] to the bot-list ([@laughedelic](https://github.com/laughedelic))
...
- add invalid-email-address to botlist ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- Add renovate-pro[bot] to bot list ([@hipstersmoothie](https://github.com/hipstersmoothie))
