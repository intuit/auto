...
- set title on canary release ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- Bump file-type from 15.0.1 to 16.0.0 ([@dependabot-preview[bot]](https://github.com/dependabot-preview[bot]))
...
- don't set baseUrl for public asset upload ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- fix upload-assets plugin ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- file deprecated for data ([@hipstersmoothie](https://github.com/hipstersmoothie))
