...
- Do not execute gh-pages build during a dry run ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- Add better verbose logging in gh-pages plugin ([@hipstersmoothie](https://github.com/hipstersmoothie))
