...
- add more logging to conventional commits ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- organize tests ([@hipstersmoothie](https://github.com/hipstersmoothie))
- add a configured label rather than the release type ([@hipstersmoothie](https://github.com/hipstersmoothie))
- fix not adding label when there is a custom release label ([@hipstersmoothie](https://github.com/hipstersmoothie))
- fix: use auto.semverLabels for finding/setting PR labels ([@hborawski](https://github.com/hborawski))
- feat: conventional commit plugin will label an unlabeled PR ([@hborawski](https://github.com/hborawski))
...
- add Github Package Registry docs ([@hipstersmoothie](https://github.com/hipstersmoothie))
