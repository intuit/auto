...
- don't thank any of the bots in bot-list ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- search for past contributions serially so that memoized graphql call works ([@hipstersmoothie](https://github.com/hipstersmoothie))
