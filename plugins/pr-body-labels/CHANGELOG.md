...
- Remove unchecked labels when pr-check runs ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- handle capital X in semver bump list ([@hipstersmoothie](https://github.com/hipstersmoothie))
...
- clarify docs on how it works ([@hipstersmoothie](https://github.com/hipstersmoothie))
- add disabledLabels option ([@hipstersmoothie](https://github.com/hipstersmoothie))
- only apply labels configured by auto ([@hipstersmoothie](https://github.com/hipstersmoothie))
