...
- gem's README, typo: you -> your ([@dorianmariefr](https://github.com/dorianmariefr))
...
- chmod creds file ([@hipstersmoothie](https://github.com/hipstersmoothie))
- use home dir ([@hipstersmoothie](https://github.com/hipstersmoothie))
- add logs ([@hipstersmoothie](https://github.com/hipstersmoothie))
- laxer auth ([@hipstersmoothie](https://github.com/hipstersmoothie))
